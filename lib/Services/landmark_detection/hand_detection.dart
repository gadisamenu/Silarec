...
class HandDetector extends AiModel {
  HandDetector({this.interpreter}) {
    loadModel();
  }
  ...
  List<double>? runHandDetector(Uint8List image) {
    if (interpreter == null) {
      print('Interpreter not initialized');
      return null;
    }

    // final tensorImage = TensorImage.fromTensorBuffer(image.buffer);
    ...
    interpreter!.runForMultipleInputs(image, outputs);
