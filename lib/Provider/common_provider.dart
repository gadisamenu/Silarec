...
// final PermissionStatus storage_permission;
// HomePage({required this.storage_permission, super.key});
...
//       )),
// );
// } else if (storage_permission.isDenied) {
//   showDialog(
//       context: context,
//       builder: (context) => const Dialog(
//             child: Text("Allow file permission"),
